...
class IRFGAN_List(AdversarialMachine):
    ...
    def burn_in(self, train_data=None):
        ...
        if self.optimal_train:
            self.super_generator.train_mode()
            self.super_discriminator.train_mode()
    ...
    def fill_global_buffer(self, train_data, dict_buffer=None):
        ...
        assert self.data_dict['train_presort'] is True  # this is required for per_query_generation()
...
class IRFGAN_ListParameter(ModelParameter):
    ...
    def default_para_dict(self):
        ...
        self.ad_para_dict = dict(model_id=self.model_id, d_epoches=d_epoches, g_epoches=g_epoches, f_div_id=f_div_id,
                            ...
                            top_k=10, PL_D=True, repTrick=True, dropLog=True)
