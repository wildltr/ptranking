...
from org.archive.ltr_adversarial.listwise.list_generator import List_Generator
from org.archive.ltr_adversarial.listwise.list_discriminator import List_Discriminator
from org.archive.ltr_adversarial.util.f_divergence import get_f_divergence_functions
from org.archive.ltr_adversarial.util.list_probability import log_ranking_prob_Bradley_Terry, log_ranking_prob_Plackett_Luce

from org.archive.utils.pytorch.pt_extensions import arg_shuffle_ties
from org.archive.ltr_adversarial.util.list_sampling import gumbel_softmax
...
class IRFGAN_ListParameter(ModelParameter):
    ...
    def grid_search(self):
        ...
        for d_g_epoches, samples_per_query, ad_training_order, temperature, f_div_id in product(choice_d_g_epoches,
                                            choice_samples_per_query, choice_ad_training_order,
                                            choice_temperatures, choice_f_div_id):
